...
exports.default = Dep;
},{}],"js/Watcher.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(Watcher, [{
    ...
    value: function get() {
      ...
      _Dep.default.target = this; // 获取值触发数据劫持

      var value = _CompileUtil.default.getVal(this.vm, this.exp); // 清空 Dep 上的 Watcher，防止重复添加
    ...
    value: function update() {
      // 获取新值
      var newValue = _CompileUtil.default.getVal(this.vm, this.exp); // 获取旧值


      var oldValue = this.value; // 如果新值和旧值不相等，就执行 callback 对 dom 进行更新
...
},{"./CompileUtil":"js/CompileUtil.js","./Dep":"js/Dep.js"}],"js/CompileUtil.js":[function(require,module,exports) {
"use strict";
...
var CompileUtil = {
  ...
  text: function text(node, vm, exp) {
    ...
    exp.replace(/\{\{([^}]+)\}\}/g, function () {
      new _Watcher.default(vm, arguments.length <= 1 ? undefined : arguments[1], function (newValue) {
  ...
  model: function model(node, vm, exp) {
    ...
    new _Watcher.default(vm, exp, function (newValue) {
      updateFn && updateFn(node, newValue);
    }); // 添加输入框事件实现双向绑定
...
},{"./Watcher":"js/Watcher.js"}],"js/Compile.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(Observer, [{
    ...
    value: function defineReactive(object, key, value) {
      ...
      var dep = new _Dep.default(); // 获取某个值被监听到
      ...
      Object.defineProperty(object, key, {
        ...
        get: function get() {
          // 当取值时调用的方法
          console.log("target:", _Dep.default.target);
...
},{"./Dep":"js/Dep.js"}],"js/MVVM.js":[function(require,module,exports) {
"use strict";
...
function () {
  function MVVM(options) {
    ...
    if (this.$el) {
      ...
      new _Observer.default(this.$data); // 将数据代理到实例上
...
},{"./Compile":"js/Compile.js","./Observer":"js/Observer.js"}],"js/app.js":[function(require,module,exports) {
"use strict";
